...
def test_overall_decoder():
    ...
    decoder = decoding(in_chanels, len(connect), residual, pool=None)
...
def test_decoder_1():
    ...
    decoder = decoding(in_chanels, len(connect), False, pool=None)
...
def test_decoder_residual():
    ...
    in_chanels = x.shape[1]
    decoder = decoding(in_chanels, len(connect), True, pool=None)
    assert decoder.out_channels == 8
